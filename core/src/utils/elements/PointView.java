...
public class PointView {
	...
	public PointView(Table root, int size, FocusListener listener) {
		super();
		this.root = root;
		this.size = size;
	...
	public void build() {
		...
		for (int i = 0; i < size; i++) {
			Img element = new Img(Assets.instance.ui.reg_ninepatch);
		...
		validatePosition();
		imgCursor = new Img(Assets.instance.ui.reg_ninepatch);
